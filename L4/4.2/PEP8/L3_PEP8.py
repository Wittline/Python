...
class My_tests(unittest.TestCase):
    ...
    def test_adding_record(self):
        res= li.add(directory('testname','testemail@hotmail.com','20','Mex'));
        self.assertTrue(res);
    
    def test_adding_record2(self):
        res= li.add(directory('testname2','testemail2@hotmail.com','25','USA'));
        self.assertTrue(res);        

    def test_adding_record3(self):
        res= li.add(directory('testname3','testemail3@hotmail.com','22','Arg'));
        self.assertTrue(res);        
